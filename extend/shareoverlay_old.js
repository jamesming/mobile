(function(){	
	...
	core.url2ShareBecomes=function(){
				...
				if( core.unit  == 1){ 
					core.urlToShare = window.location.hostname + "/user/" + core.userId + "/deploy/embed/400x300.html";
				}else{
	...
	core.create_embed_code_for_sharing=function(){
						...
						if( core.unit  == 1){
							var embed_code = '<script type="text/javascript" language="Javascript" src="http://cdn.republicproject.com/user/' +  core.userId  + '/deploy/embed/400x300.js"></script>';
						}else{
							var embed_code = '<script type="text/javascript" language="Javascript" src="http://cdn.republicproject.com/user/' +  core.userId  + '/deploy/embed/' + size + '.js"></script>';
						};
						...
						$('#facebookShareBtn').click(function(){
								...
								window.open('http://www.facebook.com/sharer.php?u='+core.urlToShare);
						});
