	...
	return {
		...
		initial_setup: function(window){
			...
			*/
			...
			if( app.isiPhone() ) $('head').prepend('<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=0" />');
		...
		*/
		...
		,setHomeScreenImage:function(){
			...
			,homeScreens = {
					 1:	app.isiPhone() ? 'unitOneIphone.png' + cachebust : 'unitOneAndroid.png' + cachebust
					,2:	'unitTwo.png'
